export default {
    ...
    WELCOME: `Benvenuto! PranzioBot ti aiuta ad organizzarti meglio con i tuoi amici per pranz(i)are assieme!
    Con /on e /off puoi attivare o disattivare gli avvisi mentre semplicemente con /pranzio avvisi tutti quanti che è ora di pranz(i)are assieme!
    Mai più chat intasate da messaggi inutili :)`,

    HELP: `
    /start           Avvia il bot e attiva la ricezione dei messaggi
